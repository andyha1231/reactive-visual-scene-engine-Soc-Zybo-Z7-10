...
HD_PWD='C:/Users/khuon/ECE520/final_project/phase3_integration/phase3_integration.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reactive_scene_top_ps.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reactive_scene_top_ps.tcl -notrace
