...
HD_PWD='C:/Users/khuon/ECE520/final_project/phase3_integration/phase3_integration.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reactive_scene_top_ps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reactive_scene_top_ps.tcl
