...
HD_PWD='C:/Users/khuon/ECE520/final_project/hdmi_test/hdmi_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_test_pattern_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_test_pattern_top.tcl -notrace
